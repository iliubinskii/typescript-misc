...
test("DateTime.setEndOfDay", () => {
  const d1 = d();

  const d2 = d1.setEndOfDay();

  const d3 = d2.setEndOfDay();

  expect(d1).datetimeToBe("1950-06-15 14:30:30");
  expect(d2).datetimeToBe("1950-06-16 00:00");
  expect(d3).toBeSameAs(d2);
});

test("DateTime.setEndOfHour", () => {
  const d1 = d();

  const d2 = d1.setEndOfHour();

  const d3 = d2.setEndOfHour();
...
test("DateTime.setEndOfMinute", () => {
  const d1 = d();

  const d2 = d1.setEndOfMinute();

  const d3 = d2.setEndOfMinute();
...
test("DateTime.setEndOfMonth", () => {
  const d1 = d();

  const d2 = d1.setEndOfMonth();

  const d3 = d2.setEndOfMonth();
...
test("DateTime.setEndOfPrevDay", () => {
  const d1 = d();

  const d2 = d1.setEndOfPrevDay();

  expect(d1).datetimeToBe("1950-06-15 14:30:30");
  expect(d2).datetimeToBe("1950-06-15 00:00");
});

test("DateTime.setEndOfPrevHour", () => {
  const d1 = d();

  const d2 = d1.setEndOfPrevHour();

  expect(d1).datetimeToBe("1950-06-15 14:30:30");
  expect(d2).datetimeToBe("1950-06-15 14:00");
});

test("DateTime.setEndOfPrevMinute", () => {
  const d1 = d();

  const d2 = d1.setEndOfPrevMinute();

  expect(d1).datetimeToBe("1950-06-15 14:30:30");
  expect(d2).datetimeToBe("1950-06-15 14:30");
});

test("DateTime.setEndOfPrevMonth", () => {
  const d1 = d();

  const d2 = d1.setEndOfPrevMonth();
...
])("DateTime.setEndOfPrevWeek", ({ expected, firstDayOfWeek }) => {
  expect(d().setEndOfPrevWeek(firstDayOfWeek)).datetimeToBe(expected);
});

test.each([
  { expected: "1950-06-11 00:00", firstDayOfWeek: 0 as const },
  { expected: "1950-06-12 00:00", firstDayOfWeek: 1 as const }
])("DateTime.setEndOfPrevWeekLocale", ({ expected, firstDayOfWeek }) => {
  expect(
    d(undefined, { firstDayOfWeek }).setEndOfPrevWeekLocale()
  ).datetimeToBe(expected);
});

test("DateTime.setEndOfPrevYear", () => {
  const d1 = d();

  const d2 = d1.setEndOfPrevYear();
...
])("DateTime.setEndOfWeek", ({ expected, firstDayOfWeek }) => {
  const d1 = d();

  const d2 = d1.setEndOfWeek(firstDayOfWeek);

  const d3 = d2.setEndOfWeek(firstDayOfWeek);
...
test.each([
  { expected: "1950-06-18 00:00", firstDayOfWeek: 0 as const },
  { expected: "1950-06-19 00:00", firstDayOfWeek: 1 as const }
])("DateTime.setEndOfWeekLocale", ({ expected, firstDayOfWeek }) => {
  const d1 = d(undefined, { firstDayOfWeek });

  const d2 = d1.setEndOfWeekLocale();

  const d3 = d2.setEndOfWeekLocale();

  expect(d2).datetimeToBe(expected);
  expect(d3).toBeSameAs(d2);
});

test("DateTime.setEndOfYear", () => {
  const d1 = d();

  const d2 = d1.setEndOfYear();

  const d3 = d2.setEndOfYear();
